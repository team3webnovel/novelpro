...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/static/css/header.css"> <!-- 헤더 스타일 추가 -->
    <script>
...
<header>
    <div class="header-container">
        <div class="top-right-links">
            ...
            <a href="<%= request.getContextPath() %>/generate-music" class="btn-primary">
                <i class="bi bi-music-note"></i> <!-- 음악 생성 -->
            </a>
            <a href="<%= request.getContextPath() %>/generate-image" class="btn-primary">
