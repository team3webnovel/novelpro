...
<body>
	<div class="container">
		...
		<form action="${pageContext.request.contextPath}/images/generate"
			method="post">
			<div class="form-group">
				<label for="checkpoint">Checkpoint:</label> <select id="checkpoint"
					name="checkpoint" class="form-control">
			...
			<div class="form-group">
				<label for="sampler_index">Sampler Index:</label> <select
					id="sampler_index" name="sampler_index" class="form-control">
			...
			<div class="form-group">
				<label for="steps">Steps (1-100):</label> <input type="range"
					id="stepsRange" name="stepsRange" min="1" max="100" value="25"
					class="form-control-range"
					oninput="document.getElementById('steps').value=this.value">
				<input type="number" id="steps" name="steps" min="1" max="100"
					value="25" class="form-control mt-2"
					oninput="document.getElementById('stepsRange').value=this.value">
			</div>
			...
			<div class="form-group">
				<label for="height">Height (64-2048):</label> <input type="range"
					id="heightRange" name="heightRange" min="64" max="2048"
					value="1152" class="form-control-range"
					oninput="document.getElementById('height').value=this.value">
				<input type="number" id="height" name="height" min="64" max="2048"
					value="1152" class="form-control mt-2"
					oninput="document.getElementById('heightRange').value=this.value">
			</div>

			<div class="form-group">
				<label for="cfg_scale">CFG Scale (1-20):</label> <input type="range"
					id="cfgScaleRange" name="cfgScaleRange" min="1" max="20" value="7"
					class="form-control-range"
					oninput="document.getElementById('cfg_scale').value=this.value">
				<input type="number" id="cfg_scale" name="cfg_scale" min="1"
					max="20" value="7" class="form-control mt-2"
					oninput="document.getElementById('cfgScaleRange').value=this.value">
			</div>

			<div class="form-group">
				<label for="seed">Seed:</label> <input type="number" id="seed"
					name="seed" class="form-control" value="1">
