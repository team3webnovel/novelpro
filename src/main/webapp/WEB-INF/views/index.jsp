...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/static/css/modal.css">
...
<body>
	...
	<div id="myModal" class="modal">
		<div class="modal-content">
			...
			<img id="imageResultImg" src="" alt="Generated Image"
				style="max-width: 100%;">
		</div>
	</div>
	...
	<section id="banner" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item type2">
				<a href="/team3webnovel/novel/novel-detail/248"> <img
					src="<%=request.getContextPath()%>/static/images/banner2.png"
					alt="Banner 2">
				</a>
			</div>
			...
			<div class="row" id="novel-list">
				...
				<c:forEach var="novel" items="${novelList}">
					<div class="col-md-4 novel" data-genre="${novel.genre}">
						<a
							href="${pageContext.request.contextPath}/novel/novel-detail/${novel.novelId}"
						...
						<div class="like-container mt-1">
							<button class="like-btn" onclick="toggleLike(${novel.novelId})">
								<span class="like-icon">❤️</span> <span
									id="like-count-${novel.novelId}">${novel.likeCount}</span>
								<!-- 좋아요 수 -->
							</button>
						</div>
