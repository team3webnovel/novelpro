...
<body>
		...
		<div class="d-flex justify-content-between align-items-center">
			...
			<div class="btn-group">
				...
				<a href="<%=request.getContextPath()%>/generate-music"
					...
					href="<%=request.getContextPath()%>/gije/test"
			...
			<div class="tab-pane fade" id="images">
				...
				<div class="row">
					<c:forEach var="image" items="${imageList}">
						<div class="col-md-4 mb-4">
							<div class="card"
								onclick="writeBoard(${image.creationId}, '${image.imageUrl }')">
								<!-- 이미지 출력 -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- 이미지 출력 -->
					<img id="modalImage" src="" alt="이미지" class="img-fluid" /> <input
						type="hidden" id="creationIdField" value="">
	...
	<div class="modal fade" id="musicModal" tabindex="-1" role="dialog"
		aria-labelledby="musicModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<!-- 음악 정보를 여기서 표시 -->
					<img id="modalMusicImage" src="" alt="Cover Image"
						class="img-fluid" />
